...
from fcca.shared.errors import ProviderError
...
_REQUIRED_MODULE: dict[str, str] = {
    "mock": "fcca.shared.providers.mock",
...
def _build_mock(settings: Settings, model_name: str, **kwargs: Any) -> BaseChatModel:
    from fcca.shared.providers.mock import MockChatModel
...
def _build_bedrock(settings: Settings, model_name: str, **kwargs: Any) -> BaseChatModel:
    from fcca.shared.providers.bedrock import build_bedrock_chat_model
...
def _build_vertex(settings: Settings, model_name: str, **kwargs: Any) -> BaseChatModel:
    from fcca.shared.providers.vertex import build_vertex_chat_model
