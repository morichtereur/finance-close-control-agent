...
from fcca.models import ActionCategory, LabelledCase, RiskLevel
...
def generate(settings: Settings | None = None) -> dict[str, Path]:
    ...
    from fcca.analytics import build_close_database  # local import to avoid a cycle
