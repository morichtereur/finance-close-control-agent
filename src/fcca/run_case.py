...
from fcca.models import CaseFailure
from fcca.presentation import console, render_case, render_failure
...
def main(argv: list[str] | None = None) -> int:
    ...
    from fcca.workflow.control_agent import ControlAgent  # imported late for CLI start-up time
