...
Thresholds come from :class:`~fcca.shared.config.Settings` and mirror the Materiality
...
from fcca.close.masterdata import FX_TO_EUR
from fcca.close.models import ControlSignal, JournalEntry
